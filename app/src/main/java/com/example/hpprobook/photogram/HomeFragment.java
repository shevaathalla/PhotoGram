...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(com.example.hpprobook.blogapp.R.layout.fragment_home, container, false);

        blog_list = new ArrayList<>();
        user_list = new ArrayList<>();

        blog_list_view = view.findViewById(com.example.hpprobook.blogapp.R.id.blog_list_view);
